    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-10 py-4"> <!--for 2 other part (categories, form) -->
            	<a onclick="window.location.href='<c:url value='/displayWasteForm'/>'" class="btn btn-primary">Back</a>
                ...
                <div class="row justify-content-center ">
                    ...
                    <div class="col-md-4 custom-bg">
                        ...
                        <div class="mb-3">
                            <input type="text" class="form-control" value="Recycle Weight Consumption" readonly>
                        </div>
                    ...
                    <div class="col-md-6">
                    	<form action="<c:url value="updateWasteForm"/>" method="post" enctype="multipart/form-data">
                        <div class="container">
                            <h3 class="mb-4"><b>Update Recycle Weight Consumption</b></h3>
