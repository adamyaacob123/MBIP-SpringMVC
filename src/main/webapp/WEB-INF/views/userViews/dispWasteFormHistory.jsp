...
<html>
<head>
    <title>Recycle Weight Consumption</title>
        ...
        function sortTable(columnIndex) {
        	...
        	$(document).ready(function() {
                ...
                $('#deleteConfirmationModal').on('show.bs.modal', function (event) {
                    ...
                    var deleteUrl = contextPath + "/deleteCarbonWaste?year=" + year + "&period=" + period;
...
<body style="background-image: url('<c:url value="/resources/assets/bg-login.png" />');">
    ...
    <div class="dashboard-content">
        <div class="dashboard-header">
            <h1 style="text-align: center;">Recycle Weight Form Consumption History</h1>
        </div>
				            ...
				            <c:forEach items="${forms}" var="form">
				                <tr>
				                    ...
				                    <td>
				                        ...
				                        <a href="<c:url value='/updateCarbonWaste?year=${form.wasteYear}&period=${form.wastePeriod}'/>" class="btn btn-warning btn-sm">Update</a>
				                        <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteConfirmationModal" data-year="${form.wasteYear}" data-period="${form.wastePeriod}">Delete</button>
				                    </td>                
				                </tr>
				            </c:forEach>
				        </tbody>
	  ...
	  <div class="modal-dialog">
	    <div class="modal-content">
	      ...
	      <div class="modal-footer">
	        ...
	        <a href="<c:url value="/displayWasteForm"/>" class="btn btn-danger" id="deleteConfirmButton">Delete</a>
	      </div>
	    </div>
	  </div>
	</div>
