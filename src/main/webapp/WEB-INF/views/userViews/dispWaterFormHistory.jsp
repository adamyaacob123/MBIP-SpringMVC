        ...
        function sortTable(columnIndex) {
        	...
        	$(document).ready(function() {
                ...
                $('#deleteConfirmationModal').on('show.bs.modal', function (event) {
                    ...
                    var deleteUrl = "${pageContext.request.contextPath}/deleteCarbonWater?year=" + year + "&period=" + period;

                    // Set the href attribute of the modal's delete button
                    var deleteButton = $(this).find('#deleteConfirmButton');
...
<body style="background-image: url('<c:url value="/resources/assets/bg-login.png" />');">
    ...
    <div class="dashboard-content">
        <div class="dashboard-header">
            <h1 style="text-align: center;">Water Form Consumption History</h1>
        </div>
				            ...
				            <c:forEach items="${forms}" var="form">
				                <tr>
				                    ...
				                    <td>
				                        ...
				                        <a href="<c:url value='/updateCarbonWater?year=${form.waterYear}&period=${form.waterPeriod}'/>" class="btn btn-warning btn-sm">Update</a>
				                        <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteConfirmationModal" data-year="${form.waterYear}" data-period="${form.waterPeriod}">Delete</button>				                    								     								   
				                    </td>                
				                </tr>
				            </c:forEach>
				        </tbody>
