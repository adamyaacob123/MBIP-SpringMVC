      ...
      <div class="d-flex">
        ...
        <div class="px-5 py-3" style="flex-grow: 1; margin-left: 250px">
          <div class="d-flex justify-content-between align-items-center">
            ...
            <div>
              <span class="text-muted text-end fst-italic">Total Users:
              ...
              <div class="col-12 col-md-6">
                <form action="userList" method="get">
                  <div class="input-group">
                    <input type="text" class="form-control" name="searchQuery" placeholder="Search users by name..."
            ...
            <div class="row mt-5">
              <div class="col-12">
                <c:if test="${participantCount > 0}">
                  <div class="d-flex justify-content-between align-items-center">
                    <h2>Participants</h2>
                    <span class="text-muted text-end fst-italic">Total Participants:
                              ...
                              <tr>
                                ...
                                <td>
                                  <c:choose>
                                    <c:when test="${not empty user.profileImageBase64}">
                                      <img src="data:image/jpeg;base64,${user.profileImageBase64}" alt="User Image"
                                        width="50" height="50" style="border-radius: 50%; object-fit: cover;" />
                                    </c:when>
                                    <c:otherwise>
                                      <img src="<c:url value='/resources/assets/blank-profile.png'/>"
                                ...
                                <td>
                                  <div class="btn-group" role="group">
                                    <a href="userDetails?userId=${user.id}"
                                      class="btn btn-sm btn-outline-primary">View</a>
                                    <a href="validateParticipant?userId=${user.id}"
              ...
              <div class="col-12">
                <c:if test="${adminCount > 0}">
                  <div class="d-flex justify-content-between align-items-center">
                    <h2>Admins</h2>
                    <span class="text-muted text-end fst-italic">Total Admins:
                                ...
                                <td>
                                  <%-- <c:choose>
                                    <c:when test="${not empty user.profile_image}">
                                      <img src="data:image/jpeg;base64,${user.profile_image}" alt="User Image"
                                        width="50" height="50" />
                                    </c:when>
                                    <c:otherwise>
                                      <img src="blank-profile.png" alt="Default Image" width="50" height="50" />
                                    </c:otherwise>
                                    </c:choose>
                                    --%> <img src="<c:url
                              value=" /resources/assets/blank-profile.png" />" alt="Default Image" width="40"
                                    height="40"/>
                                </td>
                                <td>${user.id}</td>
                                <td>${user.name}</td>
