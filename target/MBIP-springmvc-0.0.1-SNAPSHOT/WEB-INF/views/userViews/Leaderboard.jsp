                ...
                <div class="row">
                  <div class="col">
                    ...
                    <div class="list-group list-group-horizontal my-2">
                      <span class="list-group-item">Indicators:</span>
                      <span class="list-group-item fw-bold text-secondary">Pending</span>
                      <span class="list-group-item fw-bold text-success">Approved</span>
                      <span class="list-group-item fw-bold text-danger">Rejected</span>
                      <span class="list-group-item fw-bold text-muted">No Data</span>
                    </div>
                  </div>
                ...
                <table class="table table-hover table-responsive text-center align-middle table-exception">
                  <thead class="table-dark">
                    <tr>
                      ...
                      <th scope="col">Water (m³)</th>
                      <th scope="col">Electricity (kWh)</th>
                  ...
                  <tbody>
                    <c:forEach items="${qualifiedWinners}" var="winner" varStatus="status">
                      <tr
                        class="${(winner.waterStatus == 'approved') && (winner.electricityStatus == 'approved') && (winner.recycleStatus == 'approved') ? 'table-success' : ''}">
