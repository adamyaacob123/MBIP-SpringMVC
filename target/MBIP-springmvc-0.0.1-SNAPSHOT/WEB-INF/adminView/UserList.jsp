		              ...
		              <tr>
			              ...
			              <%-- <c:choose>
						    <c:when test="${not empty user.profile_image}">
						      <img src="data:image/jpeg;base64,${user.profile_image}" alt="User Image" width="50" height="50"/>
						    </c:when>
						    <c:otherwise>
						      <img src="blank-profile.png" alt="Default Image" width="50" height="50"/>
						    </c:otherwise>
						  </c:choose> --%>
							<img src="<c:url value="/resources/assets/blank-profile.png" />" alt="Default Image" width="40" height="40"/>
				        </td>
		                <td>${user.id}</td>
		                <td>${user.name}</td>
		                <td>${user.email}</td>
